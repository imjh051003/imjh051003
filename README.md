...
- 🎓 **Big Data Management**
- 📊 데이터 분석을 통해 문제를 구조화하고 인사이트를 도출하는 과정에 관심이 있습니다.
- 📈 머신러닝·통계 분석 프로젝트와 마케팅 전략 기획 프로젝트를 각각 경험했습니다.
- 🤖 Generative AI를 아이디어 확장, 문서 구조화, 코드 작성에 활용하고 있습니다.
- 🎯 앞으로 데이터 분석 역량을 마케팅과 비즈니스 의사결정에 연결하는 역할로 확장하고자 합니다.
